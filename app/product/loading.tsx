...
function Loading() {
  return (
    <div className="p-10 w-full flex flex-col lg:flex-row items-center lg:items-start justify-center space-x-4 mx-auto space-y-4 lg:space-x-4">
      <div className="flex space-x-4">
        <div className="hiden lg:inline space-y-4">
